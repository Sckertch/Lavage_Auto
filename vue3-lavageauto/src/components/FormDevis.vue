<template>
    <div class="background">
        <div class="form-container">
            ...
            <form id="form" action="http://localhost/index/Lavage_auto/controleurs/c_controleur.php" method="post" class="info-form">
...
export default {
    ...
    data() {
        return {
            ...
            progress: 0 // Ajout de la progression            
        };
    },
    methods: {
    // Cette méthode est appelée lorsque la catégorie change
        fetchDetails() {
            ...
            if (this.selectedCategory === 'prestation') {
                url = 'http://localhost/index/Lavage_auto/controleurs/Prestation.php';
            } else if (this.selectedCategory === 'produit') {
                url = 'http://localhost/index/Lavage_auto/controleurs/Produit.php';
            }
        ...
        dolist() { //Méthode pour lister les choix de l'utilisateur
            if (this.selectedDetail) {
                const existingItem = this.choix.find(item => item.detail.nom === this.selectedDetail.nom);
                if (existingItem) {
                ...
                console.log(this.choix); // Pour tester
            }
        },
        ...
        anim() {
            ...
            }, 5); // 20ms pour une durée totale de 2 secondes
        },
        checkEtanim(event){
